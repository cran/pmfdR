...
%% headings
\markboth{\textnormal{\bf \large Exercícios do R: \myID}}%
{\textnormal{\bf \large Exercícios do R: \myID}}
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{Exercícios do R (\myDate) \hfill Exam ID \myID}}

%\textbf{\large{R exercises for book \myDate \hfill Exam ID \myID}}
\vspace{0.5cm} 

Os exercícios distribuídos aqui fazem parte do conteúdo do livro \textbf{Processamento e Modelagem de Dados Financeiros com o R} por Marcelo S. Perlin, disponível na \href{https://www.amazon.com/Processamento-Modelagem-Dados-Financeiros-Portuguese/dp/8592243513/ref=sr_1_1?ie=UTF8&qid=1486642147&sr=8-1&keywords=Marcelo+perlin}{Amazon}.
...
O conteúdo aqui disponibilizado é distribuído com a \href{https://en.wikipedia.org/wiki/MIT_License}{licença do MIT}. 

\vspace*{2cm}

\begin{tabular}{p{14cm}}
\textbf{Nome:} \hrule \\[1.5cm]
\textbf{ID do estudante:} \hrule \\[1.5cm]
\end{tabular}

...
The exercises distributed here are part of the content for the book \textbf{Processing and Modelling Financial Data with R} by Marcelo S. Perlin, available \href{https://sites.google.com/view/pmfdr/home}{here}.

\vspace{0.5cm} 

\begin{center}
\includegraphics[width=0.5\linewidth]{CAPADigital_FinancialDataR}
\end{center}
